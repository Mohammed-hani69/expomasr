        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-xs text-slate-400 leading-relaxed text-justify">
              تأسست منصتنا التفاعلية والترويجية لتوفير بيئة عرض افتراضية عصرية تجمع كبرى شركات الديكور ومصانع الأثاث ومقاولات التشييد بمصر، للتواصل المباشر مع ملايين المستثمرين والراغبين في التشطيب الذكي دون تكبد مصاريف المعارض الميدانية المؤقتة الباهظة.
            </p>
